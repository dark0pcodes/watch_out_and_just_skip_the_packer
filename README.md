...
Aside from the packers already explained, there is a special type that injects its malicious code into external processes to make its detection harder. The study of those packers out of the scope of this workshop by now. However, in case you are curious enought to study this topic by your own, I recommend the following literature:
